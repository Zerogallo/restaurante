...
const styles = StyleSheet.create({
  ...
  description: { color: '#666', fontSize: 12, marginVertical: 4 },
  price: { fontSize: 14, fontWeight: '600', color: '#e67e22' },
  addButton: { backgroundColor: '#e67e22', width: 40, height: 40, borderRadius: 20, justifyContent: 'center', alignItems: 'center' },
